...
import streamlit.components.v1 as components  # 用于嵌入 HTML 文件
import folium
...
map_data = pd.read_csv("C:/Users/Lenovo/Desktop/DSS5201/data/data_for_map.csv")
line_data = pd.read_csv("C:/Users/Lenovo/Desktop/DSS5201/data/line_data.csv")


# (1) Map Visualization
world = gpd.read_file("C:/Users/Lenovo/Desktop/DSS5201/data/wk11_worldmap.geojson")
